...
- [x] Instalar e configurar as seguintes extensões no VSCode:
    ...
    - [x] **Dev Containers**: Criar ambiente de desenvolvimento isolado com `.devcontainer`.
    ...
    - [x] **Rest Client**: Testar endpoints de APIs diretamente no VSCode.
    - [x] **Live Share**: Configurar para colaboração em tempo real.
    - [x] **Figma for VSCode**: Navegar e inspecionar arquivos de design no editor.
    - [x] **SonarQube for IDE**: Detectar problemas de codificação em tempo real.
